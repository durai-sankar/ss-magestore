...
class Mage_Customer_Model_Address_Abstract extends Mage_Core_Model_Abstract
{
    ...
    public function validate()
    {
		...
		if (!Zend_Validate::is($this->getBlockno(), 'NotEmpty')) {
          //  $this->addError(Mage::helper('customer')->__('Please enter the building/block number.'));
        }
		if (!Zend_Validate::is($this->getUnitno(), 'NotEmpty')) {
         //   $this->addError(Mage::helper('customer')->__('Please enter the unit/service/walkup number.'));
        }		
